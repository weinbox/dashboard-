...
عند بداية المحادثة، اقرأ للزبون تفاصيل المنتج باختصار (الاسم والسعر والمنصة والتقييم) ثم اسأله إذا يحتاج مساعدة.`;
...
رحب به واسأله شنو يبحث عنه، وبعدها اسأله من أي موقع يحب يبحث.`;
  ...
  const tools = [
    ...
    },
    {
      ...
      description: "الدخول على موقع/متجر معين والبحث فيه. ستحصل على نتائج البحث (اسم المنتج وسعره) - اقرأها للزبون باختصار. استخدم هذه الوظيفة بعد أن يختار الزبون الموقع.",
      parameters: {
        type: "object",
        properties: {
