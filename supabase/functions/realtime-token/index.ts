...
ساعده بمعلومات عن هذا المنتج أو أجب على أسئلته.`;
...
رحب به واسأله شنو يبحث عنه، وبعدها اسأله من أي موقع يحب يبحث.`;
  ...
  const tools = [
    ...
    },
    {
      ...
      description: "الدخول على موقع/متجر معين والبحث فيه. استخدم هذه الوظيفة بعد أن يختار الزبون الموقع الذي يريد يبحث فيه.",
      parameters: {
        type: "object",
        properties: {
